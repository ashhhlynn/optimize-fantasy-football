    ...
    return (
        <div className="dfs" style={{marginLeft:"4.7%"}}>
            <Table style={{width:"504px", marginTop:"0%", backgroundColor:"#2a2f37", borderColor:"white", color:"white",}}sortable fixed>
                <Table.Header>
                    <Table.Row>
                        <Table.HeaderCell style={{fontWeight:"normal", fontSize:"12px", letterSpacing: "1px", color:"white", border:"none", backgroundColor:"#333842",  width:"40px", textAlign:"center"}}onClick={(e) => sortPos(e)}>POS</Table.HeaderCell>
                        <Table.HeaderCell style={{fontWeight:"normal", fontSize:"12px", letterSpacing: "1px", color:"white", backgroundColor:"#333842", border:"none", width:"126px"}}onClick={(e) => sortName(e)}>PLAYER</Table.HeaderCell>                    
